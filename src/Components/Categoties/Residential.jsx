...
const Residential = () => {
    ...
    return (
        <div className='text-center mt-5 animate__animated animate__zoomIn'>
            ...
            <p className='text-sm md:text-[16px]'>Residential offerings encompass single-family homes, townhouses, apartments, student housing, senior communities, and vacation rentals for diverse living preferences etc.</p>
